...
import UseCase.GameBoard.GameboardInteractor;
...
public class Status implements StatusInputBoundary{
    ...
    private int turns;
    private StatusOutputBoundary statusOutputBoundary;
    ...
    public void updateHp(int hp, int PlayerNo) {
        ...
        statusOutputBoundary.displayStatus(new StatusResponseModel(globalStatus));
    }
    ...
    public void init() {
        List<Player> players = GameboardInteractor.getPlayers();
